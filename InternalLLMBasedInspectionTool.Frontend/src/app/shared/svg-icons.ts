...
export const SvgIcons = {
  // Close/X icon
  close: (width: string | number = 24, height: string | number = 24): string => {
  ...
  // Settings/Gear icon
  settings: (width: string | number = 24, height: string | number = 24): string => {
    return `<svg width="${width}" height="${height}" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
  ...
  // Logo icon
  logo: (width: string | number = 32, height: string | number = 32): string => {
  ...
  // Arrow right icon
  arrowRight: (width: string | number = 20, height: string | number = 20): string => {
